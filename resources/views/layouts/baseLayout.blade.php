...
<head>
    ...
    <link rel="icon" href="{{ asset('images/crown-icon.png') }}" type="image/png" sizes="160x160">
            ...
            <div class="inspiration-container flex container">
                ...
                <div class="latest-news desktop">
                    ...
                    <div class="resources">
                        ...
                        <a href="{{ route('library') }}" class="@if ($showSelected == "library") {{ 'selected' }} @endif">The Purposeful Library</a>
    ...
    <footer>
        <div class="container">
            <div class="address">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem accusamus maxime suscipit. Tempore neque voluptate possimus dolores laborum nam</p>
            </div>
    
            <div class="services">
                <h3>Our Services</h3>
                <p> School of Purpose <br> <span>Wednesdays - </span> 5:30pm</p>
                <p> School of Transformation <br> <span>Sundays - </span> 9:00am</p>
            </div>
