        ...
        <form action="{{ route('editMessage', ['id' => $message->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="input-field">
                ...
                <select name="occasion" id="" >
                    ...
                    <option value="School of Transformation">School of Transformation [Sunday Service]</option>
                    <option value="School of Purpose">School of Purpose [Wednesday Service]</option>
