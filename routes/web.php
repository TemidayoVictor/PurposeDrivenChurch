...
Route::get('/pastor-olanrewaju-niyi', [NavigatorController::class, 'pastorniyi'])->name('pastorniyi');

Route::get('/pastor-olufunmi-niyi', [NavigatorController::class, 'pastorfunmi'])->name('pastorfunmi');
...
Route::get('/daily-inspiration', [NavigatorController::class, 'dailyInspiration'])->name('dailyInspiration');
Route::get('/daily-inspiration-view', [NavigatorController::class, 'dailyInspirationView'])->name('dailyInspirationView');
Route::get('/daily-inspiration-today/{id}', [NavigatorController::class, 'dailyInspirationToday'])->name('dailyInspirationToday');
